...
#define URI_IMAGE_JAR "assets/jar.png"
#define BUCKET_JAM_TOP_URI "assets/jam-top-atlas-v2.png"
#define BUCKET_JAM_MIDDLE_URI "assets/jam-middle-v2.png"
#define BUCKET_JAM_BOTTOM_URI "assets/jam-bottom-v2.png"
#define BUCKET_FRUIT_CATCH_EFFECT "assets/fruit-catch.png"
#define SOUND_POP "assets/pop.wav"
#define URI_PROJECTILE "assets/projectile.png"
#define BUCKET_SOUND_FRUIT_CLINK(buf, idx) sprintf(buf, "assets/clink%d.wav", (idx))
