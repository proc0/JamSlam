...
#define URI_PANEL_START_MENU "assets/paper_panel.png"
#define PANEL_GAME_OVER "assets/game_over_panel.png"
#define HUD_PANEL "assets/hud_panel.png"
#define FRUIT_ICON_URI "assets/fruit_icon.png"
#define URI_ICON_HEART "assets/heart.png"
#define URI_PROJECTILE_ICON "assets/projectile-icon.png"
...
void Display::Load(const ConfigData& configData) {
    ...
    mainFont = LoadFontEx("assets/Lacquer-Regular.ttf", FONTSIZE_TITLE, 0, 0);
    subFont = LoadFontEx("assets/Jua-Regular.ttf", FONTSIZE_TITLE, 0, 0);
